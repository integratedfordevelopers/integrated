...
class JobTest extends \PHPUnit_Framework_TestCase
{
    ...
    {
        /* $company Integrated\MongoDB\Content\Document\Relation\Company | \PHPUnit_Framework_MockObject_MockObject */
        $company = $this->getMock('Integrated\MongoDB\Content\Document\Relation\Company');
